...
export default function CreateNotePage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-tr from-purple-600 via-indigo-700 to-pink-600 flex items-center justify-center px-6 py-24">
        ...
        <div className="space-y-6">
          ...
          <Button
            ...
            className={cn(
              ...
              "hover:text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-pink-500",
